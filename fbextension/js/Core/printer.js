...
if (!window.PrintSetting) window.PrintSetting = PrintSetting = {
    ...
    Templates: [
        ...
        //Type: 32, //32: Phiếu chi
        {
            ...
            TemplAttrs:
                [
                    ...
                    { E: '{Ghi_Chu}', M: '{{description}}' },
                    { E: '{So_Tien_Bang_Chu}', M: '{{totalAsWords}}' }
        ...
        //Type: 64, //64:Phiếu xuất trả
        {
            ...
            TemplAttrs:
                        [
                            ...
                            { E: '{STT}', M: '{{$index + 1}}' },
                            { E: '{Ma_Hang}', M: '{{item.barcode}}' },
                            { E: '{Ten_Hang_Hoa}', M: '{{item.itemName}} <i style="display:block; width:95%; word-break:break-all;" data-ng-if="item.isSerial==true">(<span ng-repeat="s in item.serialsSelected">{{s.serial}}{{$last ? "" : ","}}</span>)</i>' },
        ...
        //Type: 128, //128:Phiếu thu
        {
            ...
            Original: '<table style="width:100%;">' +
                      ...
                      '</table>' +
                      '<div style="text-align:center;">' +
                      '<span><strong>PHIẾU THU</strong></span>' +
                      '<br/>' +
                      '<span><strong>{Ma_Phieu_Thu}</strong></span>' +
                      '</div><br/>' +
                      '<div><span>Ngày thu: {Ngay_Thu} </span></div>' +
                      '<div><span>Người thu: {Nguoi_Thu} </span></div>' +
                      '<br />' +
                      '<table style="width:100%; border-collapse: collapse">' +
                      '<tbody>' +
                      '<tr>' +
                      '<td style="width:40%;padding-left:5px"><strong><span>Loại thu</span></strong><br /></td>' +
                      '<td style="text-align:center;padding-right:5px;width:30%;"><strong><span>Hình thức</span></strong><br /></td>' +
                      '<td style="text-align:right;padding-right:5px;width:30%;"><strong><span>Thành tiền</span></strong><br /></td>' +
                      '</tr>' +
                      '<tr>' +
                      '<td style="padding-left:5px"><span >{Loai_Thu}</span><br /></td>' +
                      '<td style="text-align:center;padding-right:5px;"><span >{Hinh_Thuc}</span><br /></td>' +
                      '<td style="text-align:right;padding-right:5px;"><span >{Thanh_Tien}</span><br /></td>' +
                      '</tr>' +
                      '</tbody>' +
                      '</table><br/>' +
                      ...
                      '<table style="width:100%">' +
                      '<tr>' +
                      '<td style="text-align:right;padding-right:10%;"> Người thu &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<br/><span>(Ký và ghi rõ họ tên)</span></td>' +
                      '</tr>' +
                      '</table>',
            IsSelected: false,
            IsShow: true,
            TemplAttrs:
                [
                    ...
                    { E: '{SDT_Chi_Nhanh}', M: '{{storePhone}}' },
                    { E: '{Ngay_Thang_Nam}', M: '{{Date | date:"dd/MM/yyyy HH:mm:ss"}}' },
                    { E: '{Ngay_Thu}', M: '{{receivedDate}}' },
                    { E: '{Nguoi_Thu}', M: '{{receiver}}' },
                    { E: '{Ma_Phieu_Thu}', M: '{{code}}' },
                    { E: '{Loai_Thu}', M: '{{receiveType}}' },
                    { E: '{Hinh_Thuc}', M: '{{paymentMethodName}}' },
                    { E: '{Thanh_Tien}', M: '{{payment | number:0}}' },
                    { E: '{Ghi_Chu}', M: '{{receiveDescription}}' },
                    { E: '{Khach_Hang}', M: '{{customerName}}' }
                ]
        },
        //Type: 256, //256:Phiếu thu khách hàng
        {
            Code: 'CustomerReceiption',
            ...
            Original: '<table style="width:100%;">' +
                      ...
                      '<div><span>Ngày thu: {Ngay_Thu} </span></div>' +
                      '<div><span>Người thu: {Nguoi_Thu} </span></div>' +
                      '<div><span>Khách hàng: {Khach_Hang} </span></div>' +
                      '<br />' +
                      '<table style="width:100%; border-collapse: collapse">' +
                      '<tbody>' +
                      '<tr>' +
                      '<td style="text-align:center;padding-right:5px;width:30%;"><strong><span>Hình thức</span></strong><br /></td>' +
                      '<td style="text-align:right;padding-right:5px;width:35%;"><strong><span>Tiền thu</span></strong><br /></td>' +
                      '<td style="text-align:right;padding-right:5px;width:35%;"><strong><span>Còn lại</span></strong><br /></td>' +
                      '</tr>' +
                      '<tr>' +
                      '<td style="text-align:center;padding-right:5px;"><span>{Hinh_Thuc}</span><br /></td>' +
                      '<td style="text-align:right;padding-right:5px;"><span>{Thanh_Tien}</span><br /></td>' +
                      '<td style="text-align:right;padding-right:5px;"><span>{No_Con_Lai_Khach_Hang}</span><br /></td>' +
                      '</tr>' +
                      '</tbody>' +
                      '</table><br/>' +
                      '<p><span>Ghi chú: </span> {Ghi_Chu}</p>' +
        ...
        //Type: 258, //Phiếu in bếp
        {
            Code: 'Sale_Order_Coffee',
            Name: 'Phiếu in bếp',
            Type: 257,
            Content: '',
            Original: '<table style="width:100%;"><tbody><tr style="line-height:1;"><td style="line-height:1;"><span style="font-family:Arial;font-size:small;line-height:0.8;">{Ten_Cua_Hang}</span></td>' +
                    '</tr>' +
                    '<tr style="line-height:1;"><td style="line-height:1;"><span style="font-family:Arial;font-size:small;line-height:0.8;">Địa chỉ: {Dia_Chi_Cua_Hang}</span></td>' +
                    '</tr>' +
                    '<tr style="line-height:1;"><td style="line-height:1;"><span style="font-family:Arial;font-size:small;line-height:0.8;">Điện thoại: {SDT_Cua_Hang}</span></td>' +
                    '</tr>' +
                    '</tbody></table>' +
                    '<div style="text-align:center;"><span style="font-family:Arial;font-size:small;"><strong>PHIẾU IN BẾP</strong></span><br />' +
                    '<span style="font-family:Arial;font-size:small;"><strong>{Ma_Don_Hang}</strong></span></div><div><span style="font-family:Arial;font-size:small;"><strong>Ng&agrave;y b&aacute;n:</strong><span style="font-family:Arial;font-size:small;"> {Ngay_Xuat}</span></span></div><div><span style="font-family:Arial;font-size:small;"><strong>Kh&aacute;ch h&agrave;ng:</strong><span style="font-family:Arial;font-size:small;"> {Khach_Hang}</span></span></div><div ng-if="applyEarningPoint"><span style="font-family:Arial;font-size:small;"><strong>Điểm t&iacute;ch lũy:</strong><span style="font-family:Arial;font-size:small;"> {Diem_Con_Lai}</span></span></div><div><span style="font-family:Arial;font-size:small;"><strong>Thu ng&acirc;n:</strong><span style="font-family:Arial;font-size:small;"> {Nhan_Vien_Thu_Ngan}</span></span></div><br />' +
                    '<table border="1" style="width:100%;border-collapse:collapse;"><tbody><tr><td style="text-align:center;width:5%;"><strong><span style="font-family:Arial;font-size:small;">TT</span></strong></td>' +
                    '<td style="width:40%;padding-left:5px;"><strong><span style="font-family:Arial;font-size:small;">H&agrave;ng h&oacute;a</span></strong><br /></td>' +
                    '<td style="text-align:center;width:7%;"><strong><span style="font-family:Arial;font-size:small;">SL</span></strong><br /></td>' +
                    '</tr>' +
                    '<tr><td style="text-align:center;width:5%;"><span style="font-family:Arial;font-size:small;">{STT}</span><br /></td>' +
                    '<td style="width:40%;padding-left:5px;"><span style="font-family:Arial;font-size:small;">{Ten_Hang_Hoa}</span><br /></td>' +
                    '<td style="text-align:center;"><span style="font-family:Arial;font-size:small;">{So_Luong}</span><br /></td>' +
                    '</tr>' +
                    '</tbody></table>' +
                    '<p><span style="font-family:Arial;font-size:small;">Ghi ch&uacute;:  {Ghi_Chu}</span></p>',
            IsSelected: false,
            IsShow: true,
            TemplAttrs:
                [
    ...
    Expressions: [
        ...
        //Produce
        { M: '{Ten_Thanh_Phan}', H: 'Hiển thị tên hàng hóa tham gia vào sản xuất', T: 3 },
        { M: '{So_Luong_Thanh_Phan}', H: 'Hiển thị số lượng hàng hóa tham gia vào sản xuất', T: 3 },
        { M: '{Don_Vi_Thanh_Phan}', H: 'Hiển thị đơn vị hàng hóa tham gia vào sản xuất', T: 3 }
    ]
};