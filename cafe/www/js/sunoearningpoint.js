//SunoEarningPoint prototype is inherited from SunoSaleOrder prototype.
var F = function(){};
F.prototype = SunoSaleOrder.prototype;

function SunoEarningPoint(storeId) { 
    this.request = new SunoRequest();
    this.storeId = storeId;
 };
SunoEarningPoint.prototype = new F();
...
SunoEarningPoint.prototype.createNewOrder = function() {
    var self = this;
    ...
    var saleOrder = {
        ...
        exchangedMoney: 0,
        exchangedPoint: 0,
        earningPointStatus: self.earningPointStatus.notExchangabled
    };
